...
from core.ai.intelligence.ai_service import ai_service, embed_text
from shared.config.base_config import DEPLOYED_INDEX_ID, TOP_K, SIMILARITY_THRESHOLD, CLAIR_GREETING
